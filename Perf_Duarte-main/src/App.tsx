...
import RegistoAusencias from './assets/RegistarAusencias';
      ...
      <div className='custom-bg h-screen'>
        <Routes>
          ...
          <Route path='/main/*' element={<MainPage />}>
            ...
            <Route path='registar/ausencias' element={<RegistoAusencias />} />
            <Route path='registar/display' element={<Display />} />
            <Route path='calendario' element={<Calendario />} />
            <Route path='settings/perfil' element={<SettingsPerfil />} />
            <Route path='settings/configuracoes' element={<div>Configurações Content</div>} />
